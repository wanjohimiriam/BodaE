...
class _PrecisePickUpScreenState extends State<PrecisePickUpScreen> {
  ...
  getAddressFromLatLng(LatLng position) async {
    try {
      ...
      mainScreenController.pickupLocation.value = address;
    } catch (e) {
      rethrow;
    }
  }
            ...
            child: Center(
              child: Container(
                ...
                child: Padding(
                  ...
                  child: CustomText(
                    text: mainScreenController.pickupLocation.value.isEmpty ? "Searching..." : mainScreenController.pickupLocation.value, 
                    fontSize: 16, 
